...
$sql = "SELECT subject, email, message, date, user FROM uzenet ORDER BY date desc";
$result = $conn->query($sql);

$rows=$result->num_rows;

if ($rows > 0) {
  echo "<table class=\"t_uzenet\"><tr style=\"background-color:#F6927C\"><th>ID</th><th>Felhasználó</th><th>Email</th><th>Tárgy</th><th>Üzenet</th><th>Dátum</th></tr>";
